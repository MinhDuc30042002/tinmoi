                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="POST">
                            <h3 class="text-center text-info">Chỉnh Sửa Thể Loại</h3>
                            ...
                            <div class="form-group">
                                ...
                                <input name="anHien" value="0" <?php if($theloai['AnHien']==0) echo 'checked';?> type="radio"> Ẩn
                                <input name="anHien" value="1" <?php if($theloai['AnHien']==1) echo 'checked';?> type="radio"> Hiện
                            </div>
                            <div class="form-group">
                                <label for="">Ngôn Ngữ:</label>
                                <input name="lang" value="vi" <?php if($theloai['lang']=='vi') echo 'checked';?> type="radio"> Tiếng Việt
                                <input name="lang" value="en" <?php if($theloai['lang']=='en') echo 'checked';?> type="radio"> Tiếng Anh
                            </div>
                            <div class="form-group">
